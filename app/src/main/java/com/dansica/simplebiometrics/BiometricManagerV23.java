...
public class BiometricManagerV23 {
    ...
    private com.dansica.simplebiometrics.BiometricDialogV23 biometricDialogV23;
    protected CancellationSignal mCancellationSignalV23 = new CancellationSignal();


    public void displayBiometricPromptV23(final com.dansica.simplebiometrics.BiometricCallback biometricCallback) {
        generateKey();
            ...
            fingerprintManagerCompat.authenticate(cryptoObject, 0, mCancellationSignalV23,
                    new FingerprintManagerCompat.AuthenticationCallback() {
                        ...
                        public void onAuthenticationFailed() {
                            ...
                            updateStatus(context.getString(com.dansica.simplebiometrics.R.string.biometric_failed));
