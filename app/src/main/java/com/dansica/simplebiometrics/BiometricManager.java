...
public class BiometricManager extends BiometricManagerV23 {
    ...
    public void authenticate(@NonNull final com.dansica.simplebiometrics.BiometricCallback biometricCallback) {
    ...
    public void cancelAuthentication(){
        if(BiometricUtils.isFingerprintAuthEnable()) {
    ...
    private void displayBiometricDialog(com.dansica.simplebiometrics.BiometricCallback biometricCallback) {
        if(BiometricUtils.isFingerprintAuthEnable()) {
